...
Expression
  = column:Column _ operator:OperatorLiteral _ value:Literal?
    {
      return {
        type: 'Expression',
        column: column,
...
StringLiteral
  = '"' chars:$DoubleStringCharacter* ('"' / EOF)
    {
      return {
        type: 'Literal',
        value: chars,
...
// Tokens
NullToken = "null"i !IdentPart
TrueToken = "true"i !IdentPart
FalseToken = "false"i !IdentPart
IsToken = "is"i !IdentPart
OrToken = "or"i !IdentPart {return 'or';}
AndToken = "and"i !IdentPart {return 'and';}



// Taken from javascript.pegjs
...
ExponentPart
  = "e"i SignedInteger {return text();}

SignedInteger
  = [+-] DecimalDigit+ {return text();}

HexIntegerLiteral
  = "0x"i digits:$HexDigit+ {return {type: 'Literal', value: parseInt(digits, 16)}}
